...
<p>NOT: 5 gece altı konaklamaya 3500 TL temizlik ücreti alınmaktadır. Ara temizlik ücreti ise 2500 TL'dir. Ek yatak için ekstra ücret olarak 3000 TL alınmaktadır. Evcil hayvan kabul edilmekte olup bunun için ekstra 3000 TL ödeme alınmaktadır.</p>
`;
...
assert.equal(heryerDefaults.cleaningFee, 3500);
assert.equal(heryerDefaults.extraBedFee, 3000);
assert.equal(heryerDefaults.petCleaningFee, 3000);
