...
export async function getVillaDetailBySlug(
  ...
  return {
    ...
    calendarDays: calendarDays.map((day) => ({
      ...
      damageDepositCurrency: day.damageDepositCurrency,
      petCleaningFee: day.petCleaningFee,
      petCleaningFeeCurrency: day.petCleaningFeeCurrency,
      petDamageDeposit: day.petDamageDeposit,
      petDamageDepositCurrency: day.petDamageDepositCurrency,
      underfloorHeatingFee: day.underfloorHeatingFee,
      underfloorHeatingFeeCurrency: day.underfloorHeatingFeeCurrency,
      extraBedFee: day.extraBedFee,
      extraBedFeeCurrency: day.extraBedFeeCurrency,
      poolHeatingPrivateFee: day.poolHeatingPrivateFee,
      poolHeatingPrivateFeeCurrency: day.poolHeatingPrivateFeeCurrency,
      poolHeatingIndoorFee: day.poolHeatingIndoorFee,
      poolHeatingIndoorFeeCurrency: day.poolHeatingIndoorFeeCurrency,
      poolHeatingKidsFee: day.poolHeatingKidsFee,
      poolHeatingKidsFeeCurrency: day.poolHeatingKidsFeeCurrency,
    })),
  };
}
