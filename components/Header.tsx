        ...
        <div className="hidden shrink-0 flex-col gap-1.5 md:flex md:w-[272px] lg:w-[320px] xl:w-[340px]">
          <div className="flex min-w-0 items-center gap-2">
            <a
              ...
              className="flex min-w-0 flex-1 items-center justify-center gap-1.5 rounded-full bg-[#0F766E] px-3 py-1.5 text-xs font-semibold text-white shadow-sm transition hover:bg-[#0D5C56] sm:text-sm"
