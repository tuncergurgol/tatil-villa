...
export default function AmenityMultiSelect({
  ...
  return (
    ...
    >
      ...
      <div className="absolute left-0 right-0 top-full z-30 mt-1 w-full max-w-full overflow-hidden rounded-xl border border-gray-200 bg-white shadow-xl sm:min-w-80">
